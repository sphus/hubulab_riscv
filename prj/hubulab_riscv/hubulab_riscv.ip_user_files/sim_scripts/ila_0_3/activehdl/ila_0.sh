...
#
# Script generated by Vivado on Wed Mar 26 19:05:23 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/project/RISC-V/work/hubulab_riscv/prj/hubulab_riscv/hubulab_riscv.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
